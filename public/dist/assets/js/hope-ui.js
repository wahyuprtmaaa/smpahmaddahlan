...
$(document).ready(function () {
    $('.detail-btn').click(function () {
        let id = $(this).data('id');
        $.ajax({
            url: `/admin/siswa/${id}/detail`,
            type: 'GET',
            success: function (data) {
                $('#modalNama').text(data.nama);
                $('#modalNisn').text(data.nisn);
                $('#modalNis').text(data.nis);
                $('#modalKelas').text(data.kelas.nama);
                $('#modalAlamat').text(data.alamat);
                $('#modalTelepon').text(data.telepon);
                $('#modalTanggalLahir').text(data.tanggal_lahir);
                $('#modalJenisKelamin').text(data.jenis_kelamin === 'L' ? 'Laki-laki' : 'Perempuan');
                $('#modalWali').text(data.wali?.name ?? '-');
                $('#modalFoto').attr('src', data.foto_url);
    ...
    $('.edit-btn').click(function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $('#edit-jenis_kelamin').val(response.siswa.jenis_kelamin);
                $('#edit-tanggal_lahir').val(response.siswa.tanggal_lahir);
